...
fcgi_connection_manager.o: fcgi_connection_manager.h rapunzel_util.h
fcgi_connection.o: fcgi_connection_manager.h fcgi_connection.h rapunzel_util.h
fcgi_request.o: fcgi_request.h fcgi_connection.h
rapunzel_util.o: rapunzel_util.h
fcgi_connection_manager.h: fcgi_connection.h
fcgi_connection.h: fcgi_types.h fcgi_request.h
# Rules
rapunzel.a: ${OBJS}
	ar rs $@ $^ 
clean:
